...
function Partners() {
  return (
    <section
      ...
      // }}
      className="bg-contain bg-primary shadow-[0_0_30px_-15px] z-10"
    >
      <div className="flex items-center justify-center px-[10%] py-10 gap-40 max-2xl:px-[8%] max-2xl:gap-32 max-2xl:py-6 max-md:flex-col max-md:gap-4">
        <SpanL className="text-tertiary text-lg font-bold max-2xl:text-base max-2xl:font-bold max-md:text-center">
          Home.Partners.title
        </SpanL>
