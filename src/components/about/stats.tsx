...
import PaperTowelInteraction2 from "../../../public/images/paper-towel-interaction-2.jpg";
...
function Stats() {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-end gap-32 max-md:flex-col max-md:gap-8">
      ...
      <div className="flex gap-10 aspect-[2.2] max-2xl:gap-6 max-md:flex-col max-md:gap-2">
        ...
        >
          <span className="text-6xl font-semibold">45%</span>
          <div className="flex flex-col gap-1">
            <SpanL className="text-xl font-medium">{`About.Stats.${ProductRatio[0].key}.title`}</SpanL>
            <SpanL
              style={{ textWrap: "stable" }}
              className="text-base max-md:text-wrap"
            >
        ...
        <div className="flex-1 flex flex-col gap-10 max-2xl:gap-6 max-2xl:flex-5 max-md:flex-1">
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <SpanL className="text-xl font-medium">{`About.Stats.${ProductRatio[1].key}.title`}</SpanL>
              <SpanL style={{ textWrap: "stable" }} className="text-base">
        ...
        <div className="flex-1 flex flex-col gap-10 max-2xl:gap-6 max-2xl:flex-5 max-md:flex-1">
          <motion.div
            ...
            className="flex flex-col flex-5 justify-between bg-primary/35 p-8 max-md:p-6 max-md:gap-2"
          >
            <span className="text-6xl font-semibold">25%</span>
            <div className="flex flex-col gap-1">
              <SpanL className="text-xl font-medium">{`About.Stats.${ProductRatio[2].key}.title`}</SpanL>
              <SpanL style={{ textWrap: "stable" }} className="text-base">
          ...
          >
            <Image
              src={PaperTowelInteraction2}
              alt={"paper-towel-interaction-2"}
              fill
              priority
              sizes="100%"
